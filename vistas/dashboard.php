...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-info">
                    ...
                    <div class="card-body">
                        <div class="chart">
                            <canvas id="barChart" style="min-height: 350px; height: 350px; max-height: 350px; width: 100%;">
                            </canvas>
                        </div>
                    </div> <!-- ./ end card-body -->
        ...
        <div class="row"><!-- ./row Productos más vendidos -->
            <div class="col-lg-6">
                <div class="card card-info">
                    <div class="card-header">
...
<script>
    $(document).ready(function() {
        ...
        /* =======================================================
        SOLICITUD AJAX 10 PRODUCTOS MÁS VENDIDOS
        =======================================================*/
